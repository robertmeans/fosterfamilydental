  ...
  class Magzimum_Social_Widget extends WP_Widget {
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        ?>
        <p>
          <label for="<?php echo $this->get_field_id( 'title'); ?>"><?php _e('Title:', 'magzimum'); ?></label>
          <input class="widefat" id="<?php echo $this->get_field_id( 'title'); ?>" name="<?php echo $this->get_field_name('title'); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'custom_class' ); ?>"><?php _e( 'Custom Class:', 'magzimum' ); ?></label>
  ...
  class Magzimum_Latest_News_Widget extends WP_Widget {
                ...
                <div class="latest-news-text-wrap">
                  ...
                  <?php if ( false == $disable_excerpt ): ?>
                    <div class="latest-news-summary">
                      <p><?php echo magzimum_get_the_excerpt( $excerpt_length, $post ); ?></p>
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'post_category' ); ?>"><?php _e( 'Category:', 'magzimum' ); ?></label>
          <?php
            $cat_args = array(
                'orderby'         => 'name',
                'hide_empty'      => 0,
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'post_column' ); ?>"><?php _e('Number of Columns:', 'magzimum' ); ?></label>
          <?php
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'featured_image' ); ?>"><?php _e( 'Featured Image:', 'magzimum' ); ?></label>
          <?php
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'post_number' ); ?>"><?php _e('Number of Posts:', 'magzimum' ); ?></label>
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'excerpt_length' ); ?>"><?php _e('Excerpt Length:', 'magzimum' ); ?></label>
        ...
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_excerpt' ); ?>" name="<?php echo $this->get_field_name( 'disable_excerpt' ); ?>" type="checkbox" <?php checked(isset($instance['disable_excerpt']) ? $instance['disable_excerpt'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_excerpt' ); ?>"><?php _e( 'Disable Excerpt', 'magzimum' ); ?>
          </label>
        </p>
        <p><input id="<?php echo $this->get_field_id( 'disable_date' ); ?>" name="<?php echo $this->get_field_name( 'disable_date' ); ?>" type="checkbox" <?php checked(isset($instance['disable_date']) ? $instance['disable_date'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_date' ); ?>"><?php _e( 'Disable Date', 'magzimum' ); ?>
          </label>
        </p>
        <p><input id="<?php echo $this->get_field_id( 'disable_comment' ); ?>" name="<?php echo $this->get_field_name( 'disable_comment' ); ?>" type="checkbox" <?php checked(isset($instance['disable_comment']) ? $instance['disable_comment'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_comment' ); ?>"><?php _e( 'Disable Comment', 'magzimum' ); ?>
          </label>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_category' ); ?>" name="<?php echo $this->get_field_name( 'disable_category' ); ?>" type="checkbox" <?php checked(isset($instance['disable_category']) ? $instance['disable_category'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_category' ); ?>"><?php _e( 'Disable Category', 'magzimum' ); ?>
          </label>
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'custom_class' ); ?>"><?php _e( 'Custom Class:', 'magzimum' ); ?></label>
  ...
  class Magzimum_Ad_Widget extends WP_Widget {
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'ad_code' ); ?>"><?php _e( 'Adv Code:', 'magzimum' ); ?></label>
        ...
        <div>
          <label for="<?php echo $this->get_field_id( 'image_url' ); ?>"><?php _e( 'Image URL:', 'magzimum' ); ?></label><br/>
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'link_url' ); ?>"><?php _e( 'Link URL:', 'magzimum' ); ?></label>
          <input class="widefat" id="<?php echo $this->get_field_id( 'link_url' ); ?>" name="<?php echo $this->get_field_name( 'link_url' ); ?>" type="text" value="<?php echo esc_attr( $link_url ); ?>" />
        </p>
        <p><input id="<?php echo $this->get_field_id( 'open_in_new_window' ); ?>" name="<?php echo $this->get_field_name( 'open_in_new_window' ); ?>" type="checkbox" <?php checked( isset( $instance['open_in_new_window'] ) ? $instance['open_in_new_window'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'open_in_new_window' ); ?>"><?php _e( 'Open in new window', 'magzimum' ); ?></label>
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'alt_text' ); ?>"><?php _e( 'Alt Text:', 'magzimum' ); ?></label>
      ...
      function form( $instance ) {
        ...
        <div class="custom-theme-accordion">
          ...
          <div class="accordion-content active">
            <p>
              <label for="<?php echo $this->get_field_id( 'popular_title' ); ?>"><?php _e( 'Tab Title:', 'magzimum' ); ?></label>
            ...
            <p>
              <label for="<?php echo $this->get_field_id( 'popular_number' ); ?>"><?php _e( 'Number of Posts:', 'magzimum' ); ?></label>
              <input id="<?php echo $this->get_field_id( 'popular_number' ); ?>" name="<?php echo $this->get_field_name( 'popular_number' ); ?>" type="number" min="1" value="<?php echo esc_attr( $popular_number ); ?>" style="max-width:50px;"/>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'popular_show_date' ); ?>" name="<?php echo $this->get_field_name( 'popular_show_date' ); ?>" type="checkbox" <?php checked( isset( $instance['popular_show_date'] ) ? $instance['popular_show_date'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'popular_show_date' ); ?>"><?php _e( 'Show Date', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'popular_show_comment' ); ?>" name="<?php echo $this->get_field_name( 'popular_show_comment' ); ?>" type="checkbox" <?php checked( isset( $instance['popular_show_comment'] ) ? $instance['popular_show_comment'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'popular_show_comment' ); ?>"><?php _e( 'Show Comment', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'popular_show_thumbnail' ); ?>" name="<?php echo $this->get_field_name( 'popular_show_thumbnail' ); ?>" type="checkbox" <?php checked( isset( $instance['popular_show_thumbnail'] ) ? $instance['popular_show_thumbnail'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'popular_show_thumbnail' ); ?>"><?php _e( 'Show Thumbnail', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'popular_show_category' ); ?>" name="<?php echo $this->get_field_name( 'popular_show_category' ); ?>" type="checkbox" <?php checked( isset( $instance['popular_show_category'] ) ? $instance['popular_show_category'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'popular_show_category' ); ?>"><?php _e( 'Show Category', 'magzimum' ); ?></label>
            </p>
          </div>
          <h4 class="accordion-toggle"><?php _e( 'Recent Posts', 'magzimum' ); ?></h4>
          <div class="accordion-content">
            <p>
              <label for="<?php echo $this->get_field_id( 'recent_title' ); ?>"><?php _e( 'Tab Title:', 'magzimum' ); ?></label>
            ...
            <p>
              <label for="<?php echo $this->get_field_id( 'recent_number' ); ?>"><?php _e( 'Number of Posts:', 'magzimum' ); ?></label>
              <input id="<?php echo $this->get_field_id( 'recent_number' ); ?>" name="<?php echo $this->get_field_name( 'recent_number' ); ?>" type="number" min="1" value="<?php echo esc_attr( $recent_number ); ?>" style="max-width:50px;"/>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'recent_show_date' ); ?>" name="<?php echo $this->get_field_name( 'recent_show_date' ); ?>" type="checkbox" <?php checked( isset( $instance['recent_show_date'] ) ? $instance['recent_show_date'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'recent_show_date' ); ?>"><?php _e( 'Show Date', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'recent_show_comment' ); ?>" name="<?php echo $this->get_field_name( 'recent_show_comment' ); ?>" type="checkbox" <?php checked( isset( $instance['recent_show_comment'] ) ? $instance['recent_show_comment'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'recent_show_comment' ); ?>"><?php _e( 'Show Comment', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'recent_show_thumbnail' ); ?>" name="<?php echo $this->get_field_name( 'recent_show_thumbnail' ); ?>" type="checkbox" <?php checked( isset( $instance['recent_show_thumbnail'] ) ? $instance['recent_show_thumbnail'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'recent_show_thumbnail' ); ?>"><?php _e( 'Show Thumbnail', 'magzimum' ); ?></label>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'recent_show_category' ); ?>" name="<?php echo $this->get_field_name( 'recent_show_category' ); ?>" type="checkbox" <?php checked( isset( $instance['recent_show_category'] ) ? $instance['recent_show_category'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'recent_show_category' ); ?>"><?php _e( 'Show Category', 'magzimum' ); ?></label>
            </p>
          </div>
          <h4 class="accordion-toggle"><?php _e( 'Comments', 'magzimum' ); ?></h4>
          <div class="accordion-content">
            <p>
              <label for="<?php echo $this->get_field_id( 'comment_title' ); ?>"><?php _e( 'Tab Title:', 'magzimum' ); ?></label>
              <input class="widefat" id="<?php echo $this->get_field_id( 'comment_title' ); ?>" name="<?php echo $this->get_field_name( 'comment_title' ); ?>" type="text" value="<?php echo esc_attr( $comment_title ); ?>" />
            </p>
            <p>
              <label for="<?php echo $this->get_field_id( 'comment_number' ); ?>"><?php _e( 'Number of Comments:', 'magzimum' ); ?></label>
              <input id="<?php echo $this->get_field_id( 'comment_number' ); ?>" name="<?php echo $this->get_field_name( 'comment_number' ); ?>" type="number" min="1" value="<?php echo esc_attr( $comment_number ); ?>" style="max-width:50px;"/>
            </p>
            <p>
              <input id="<?php echo $this->get_field_id( 'comment_show_date' ); ?>" name="<?php echo $this->get_field_name( 'comment_show_date' ); ?>" type="checkbox" <?php checked( isset( $instance['comment_show_date'] ) ? $instance['comment_show_date'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'comment_show_date' ); ?>"><?php _e( 'Show Date', 'magzimum' ); ?></label>
            </p>
  ...
  class Magzimum_Special_Posts_Widget extends WP_Widget {
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'post_id' ); ?>"><?php _e( 'Enter Post ID:', 'magzimum' ); ?></label>
          <input id="<?php echo $this->get_field_id( 'post_id' ); ?>" name="<?php echo $this->get_field_name( 'post_id' ); ?>" type="text" value="<?php echo esc_attr( $post_id ); ?>"  style="max-width:60px;" />
          <input id="<?php echo $this->get_field_id( 'post_id_2' ); ?>" name="<?php echo $this->get_field_name( 'post_id_2' ); ?>" type="text" value="<?php echo esc_attr( $post_id_2 ); ?>" style="max-width:60px;" />
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'post_category' ); ?>"><?php _e( 'Category:', 'magzimum' ); ?></label>
          <?php
...
class Magzimum_Categorized_News_Widget extends WP_Widget {
              ...
              <div class="col-sm-6">
                ...
                <?php if ( ! empty( $all_posts ) ): ?>
                  ...
                  <?php if ( false == $disable_excerpt_main ): ?>
                    <p><?php echo magzimum_get_the_excerpt( $excerpt_length_main, $post ); ?></p>
                  <?php endif ?>
                    ...
                    <?php foreach ( $all_posts as $key => $post ): ?>
                      ...
                      <div class="categorized-news-text-wrap">
                        ...
                        <?php if ( false == $disable_excerpt_side ): ?>
                          <p><?php echo magzimum_get_the_excerpt( $excerpt_length_side, $post ); ?></p>
                        <?php endif ?>
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'post_category' ); ?>"><?php _e( 'Select Category:', 'magzimum' ); ?></label>
          <?php
            $cat_args = array(
                'orderby'         => 'name',
                'hide_empty'      => 0,
        ...
        <p>
          <input id="<?php echo $this->get_field_id( 'show_more_icon' ); ?>" name="<?php echo $this->get_field_name( 'show_more_icon' ); ?>" type="checkbox" <?php checked(isset($instance['show_more_icon']) ? $instance['show_more_icon'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'show_more_icon' ); ?>"><?php _e( 'Show View More Icon', 'magzimum' ); ?><br/><small><?php _e( 'Icon will be displayed only if Category is selected.', 'magzimum' ); ?></small>
          </label>
        </p>
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'featured_image' ); ?>"><?php _e( 'Select Image Size:', 'magzimum' ); ?></label>
          <?php
            $this->dropdown_image_sizes( array(
              'id'       => $this->get_field_id( 'featured_image' ),
              'name'     => $this->get_field_name( 'featured_image' ),
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'excerpt_length_main' ); ?>"><?php _e('Excerpt Length:', 'magzimum' ); ?></label>
          <input class="widefat1" id="<?php echo $this->get_field_id( 'excerpt_length_main' ); ?>" name="<?php echo $this->get_field_name( 'excerpt_length_main' ); ?>" type="number" value="<?php echo esc_attr( $excerpt_length_main ); ?>" min="1" style="max-width:50px;" />&nbsp;<small><?php _e( 'in words', 'magzimum' ); ?></small>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_excerpt_main' ); ?>" name="<?php echo $this->get_field_name( 'disable_excerpt_main' ); ?>" type="checkbox" <?php checked(isset($instance['disable_excerpt_main']) ? $instance['disable_excerpt_main'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_excerpt_main' ); ?>"><?php _e( 'Disable Excerpt', 'magzimum' ); ?>
          </label>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_date_main' ); ?>" name="<?php echo $this->get_field_name( 'disable_date_main' ); ?>" type="checkbox" <?php checked(isset($instance['disable_date_main']) ? $instance['disable_date_main'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_date_main' ); ?>"><?php _e( 'Disable Date', 'magzimum' ); ?>
          </label>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_comment_main' ); ?>" name="<?php echo $this->get_field_name( 'disable_comment_main' ); ?>" type="checkbox" <?php checked(isset($instance['disable_comment_main']) ? $instance['disable_comment_main'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_comment_main' ); ?>"><?php _e( 'Disable Comment', 'magzimum' ); ?>
          </label>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_category_main' ); ?>" name="<?php echo $this->get_field_name( 'disable_category_main' ); ?>" type="checkbox" <?php checked(isset($instance['disable_category_main']) ? $instance['disable_category_main'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_category_main' ); ?>"><?php _e( 'Disable Category', 'magzimum' ); ?>
          </label>
        </p>
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'thumbnail_size' ); ?>"><?php _e( 'Thumbnail Width:', 'magzimum' ); ?></label>
          <input id="<?php echo $this->get_field_id( 'thumbnail_size' ); ?>" name="<?php echo $this->get_field_name( 'thumbnail_size' ); ?>" type="number" value="<?php echo esc_attr( $thumbnail_size ); ?>" min="1" style="max-width:50px;" />&nbsp;<small><?php _e( 'in px', 'magzimum' ); ?></small>
        </p>
        <p>
          <label for="<?php echo $this->get_field_id( 'excerpt_length_side' ); ?>"><?php _e('Excerpt Length:', 'magzimum' ); ?></label>
          <input class="widefat1" id="<?php echo $this->get_field_id( 'excerpt_length_side' ); ?>" name="<?php echo $this->get_field_name( 'excerpt_length_side' ); ?>" type="number" value="<?php echo esc_attr( $excerpt_length_side ); ?>" min="1" style="max-width:50px;" />&nbsp;<small><?php _e( 'in words', 'magzimum' ); ?></small>
        </p>
        <p>
          <input id="<?php echo $this->get_field_id( 'disable_excerpt_side' ); ?>" name="<?php echo $this->get_field_name( 'disable_excerpt_side' ); ?>" type="checkbox" <?php checked(isset($instance['disable_excerpt_side']) ? $instance['disable_excerpt_side'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_excerpt_side' ); ?>"><?php _e( 'Disable Excerpt', 'magzimum' ); ?>
          </label>
        </p>
        <p><input id="<?php echo $this->get_field_id( 'disable_date_side' ); ?>" name="<?php echo $this->get_field_name( 'disable_date_side' ); ?>" type="checkbox" <?php checked(isset($instance['disable_date_side']) ? $instance['disable_date_side'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_date_side' ); ?>"><?php _e( 'Disable Date', 'magzimum' ); ?>
          </label>
        </p>
        <p><input id="<?php echo $this->get_field_id( 'disable_comment_side' ); ?>" name="<?php echo $this->get_field_name( 'disable_comment_side' ); ?>" type="checkbox" <?php checked(isset($instance['disable_comment_side']) ? $instance['disable_comment_side'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_comment_side' ); ?>"><?php _e( 'Disable Comment', 'magzimum' ); ?>
          </label>
        </p>
        <p><input id="<?php echo $this->get_field_id( 'disable_category_side' ); ?>" name="<?php echo $this->get_field_name( 'disable_category_side' ); ?>" type="checkbox" <?php checked(isset($instance['disable_category_side']) ? $instance['disable_category_side'] : 0); ?> />&nbsp;<label for="<?php echo $this->get_field_id( 'disable_category_side' ); ?>"><?php _e( 'Disable Category', 'magzimum' ); ?>
          </label>
        </p>
